...
<div class="uk-position-z-index uk-width-1-1" data-globals="menu" uk-sticky="start: 800; animation: uk-animation-slide-top">
    ...
    <nav uk-navbar class="uk-navbar-container uk-navbar-transparent">
        ...
        <div class="uk-navbar-right">
            <ul class="uk-navbar-nav uk-visible@l" hidden>
            ...
            <ul class="uk-subnav uk-margin-remove uk-visible@l" hidden>
            ...
            <button type="button" role="button" class="uk-navbar-toggle uk-hidden@l" uk-navbar-toggle-icon uk-toggle="target: #mobile" aria-label="Toggle Mobile Menu" hidden></button>
        </div>
    </nav>
