    ...
    <div id="sgg-section">
            ...
            <div class="uk-container uk-container-expand uk-margin-medium">
                <div class="uk-child-width-1-2@m uk-flex-middle" uk-grid>
                    <div class="column-media">
                        <img src="<?php echo _uri.'/resources/images/change-the-game.png'; ?>" alt="Social Media Marketing is Changing the Game" uk-scrollspy="cls: uk-animation-scale-up uk-transform-origin-top-center; delay: 600">
                    </div>
                    <div class="column-content">
                        <article class="uk-article">
                            <div class="about-section-one" uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 600">
                            ...
                            <div class="about-section-two" uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 900">
        ...
        <section id="micro-influencer" class="micro-influencer | section">
            <div class="uk-child-width-1-2@l uk-grid-match uk-flex-middle" uk-grid>
                <div class="column-content">
                    <article class="uk-article">
                        <div uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 300">
                        ...
                        <picture uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 600">
                ...
                <div class="column-media | uk-flex uk-flex-middle uk-flex-center">
                    <div class="video-container" uk-scrollspy="cls: uk-animation-fade-medium; delay: 600">
        ...
        <section id="live-drive" class="live-drive | section">
            <div class="uk-grid-collapse uk-grid-match uk-flex-middle" uk-grid>
                <div class="column-media | uk-width-1-2@l">
                    <picture uk-scrollspy="cls: uk-animation-slide-left-medium; delay: 300">
                ...
                <div class="column-content | uk-width-1-2@l uk-flex uk-flex-center">
                    <div class="uk-card" uk-scrollspy="cls: uk-animation-slide-right-medium; delay: 600">
                        <div class="uk-card-body">
        ...
        <section id="franchise" class="franchise | section">
            <div class="uk-container uk-container-expand">
                ...
                <div class="uk-child-width-1-2@m uk-grid-large uk-grid-match uk-flex-middle" uk-grid>
                    <div class="column-content">
                        <article class="uk-article" uk-scrollspy="cls: uk-animation-slide-left-medium; delay: 300">
                    ...
                    <div class="column-media">
                        <picture uk-scrollspy="cls: uk-animation-scale-up; delay: 600">
        ...
        <section id="followers-chart" class="followers-chart | section">
            <div class="uk-container uk-container-expand">
                ...
                <div class="uk-grid-match uk-grid-collapse uk-flex-middle uk-flex-center" uk-grid>
                    <div class="column-media | uk-width-1-2@m uk-flex uk-flex-center uk-flex-middle" uk-scrollspy="cls: uk-animation-slide-top; delay: 300">
                    ...
                    <div class="column-media-chart | uk-width-1-2@m uk-flex uk-flex-middle" uk-scrollspy="cls: uk-animation-slide-right-medium; delay: 600">
        ...
        <section id="graph" class="graph | section">
            <div class="uk-container uk-container-expand">
                ...
                <div class="graph-container">
                    <header class="uk-panel uk-text-center" uk-scrollspy="cls: uk-animation-scale-up; delay: 300">
                    ...
                    <figure class="chart-container" uk-scrollspy="cls: uk-animation-slide-bottom-medium; delay: 600">
        ...
        <section id="team" class="team | section">
            ...
            <div class="uk-container">
                <header class="uk-panel" uk-scrollspy="cls: uk-animation-fade-medium; delay: 300">
                    <p>Our Professional</p>
                    <h2 class="team-headline">Management Team</h2>
                    <p>A Division of Sports Gambling GUides, Inc.</p>
                </header>

                <div class="executives | uk-child-width-auto@s uk-flex-center" uk-grid uk-scrollspy="target: > .column-content > .uk-card; cls: uk-animation-slide-bottom-medium; delay: 300">
            ...
            <div class="uk-container uk-container-small">
                <div class="marketing | uk-child-width-auto@s uk-grid-small uk-grid-match uk-flex-center" uk-grid uk-height-match="target: > div > .uk-card > p" uk-scrollspy="target: > div > .uk-card; cls: uk-animation-slide-bottom-medium; delay: 300">
