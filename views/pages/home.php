...
<main id="main" class="main m-scene" role="main">
    ...
    <div id="sgg-section">
        <section id="hero" class="home-hero | section fp-auto-height">
            <figure>
                <div class="uk-position-relative" uk-slideshow="autoplay: true; animation: fade; autoplay-interval: 5000">
        ...
        <section id="followers-chart" class="followers-chart | section">
            <div class="uk-container uk-container-expand">
                ...
                <div class="uk-grid-match uk-grid-collapse uk-flex-middle uk-flex-center" uk-grid>
                    <div class="column-media | uk-width-1-2@m uk-flex uk-flex-center uk-flex-middle">
                    ...
                    <div class="column-media-chart | uk-width-1-2@m uk-flex uk-flex-middle">
        ...
        <section id="team" class="team | section">
            ...
            <div class="uk-container">
                ...
                <div class="executives | uk-child-width-auto@s uk-flex-center" uk-grid>
            ...
            <div class="uk-container uk-container-small">
                <div class="marketing | uk-child-width-auto@s uk-grid-small uk-grid-match uk-flex-center" uk-grid uk-height-match="target: > div > .uk-card > p">
