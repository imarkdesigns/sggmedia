<main id="main" class="main uk-position-relative" role="main">
        ...
        <div class="uk-container uk-container-small">
            ...
            <div uk-grid class="uk-grid-small uk-grid-divider uk-grid-match uk-flex-middle">
                <div class="uk-width-auto">
                    <img src="<?php echo _uri.'/resources/images/articles/iGB-logo.png' ?>" width="100" alt="iGB Logo">
                </div>
    ...
    <section class="goal | uk-section uk-section-muted" hidden>
    ...
    <section class="capture-via-cellphones | uk-section" hidden>
        <div class="uk-container">
    ...
    <section id="partners" class="partners | uk-section" hidden>
        <div class="uk-container">
            <div class="uk-headings uk-margin-medium-bottom">
    ...
    <section id="podcast" class="podcast | uk-section uk-section-secondary" hidden>
        <div class="uk-container">
            ...
            */ ?>
            ...
            <div class="uk-text-center uk-margin-large-top">
                <a href="<?php echo esc_url( get_permalink( 469 ).'#sgg-SS' ); ?>" class="uk-button uk-button-secondary uk-button-large uk-border-rounded">View All Videos & Podcasts</a>
            </div>
    ...
    <div class="sbc-awards | uk-section uk-section-secondary" hidden>
    ...
    <section id="connection" class="advertising connection | uk-section" hidden>
        <div class="uk-container">
    ...
    <section id="revenue" class="advertising revenue | uk-section uk-section-muted" hidden>
        <div class="uk-container">
    ...
    <section class="team marketing | uk-section uk-padding-remove-top">
        <div class="uk-container uk-container-small">
            ...
            <?php while ( have_rows( 'sc_team' ) ) : the_row();
                if ( get_row_index() < 3 ) {
                    $class = 'class="team-item | uk-width-1-1"';
                } else {
                    $class = 'class="team-item | uk-width-1-1"';
                } ?>
                <div <?=$class?>>
    ...
    <section class="about | uk-section uk-section-muted" hidden>
        <div class="uk-container">
    ...
    <section class="advertise-with-sgg | uk-section uk-padding-remove-vertical" hidden>
        <div class="uk-container">
